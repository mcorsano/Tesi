...
parser.add_argument("--epoch", type=int, default=19, help="epoch to start training from")
parser.add_argument("--n_epochs", type=int, default=200, help="number of epochs of training")
parser.add_argument("--dataset_name", type=str, default="mouse_noisy_big_dataset", help="name of the dataset")
...
for epoch in range(opt.epoch, opt.n_epochs):
    for i, imgs in enumerate(dataloader):
        ...
        if batches_done % opt.sample_interval == 0:
            ...
            save_image(img_grid, "./images/training/%d.tiff" % batches_done, nrow=1, normalize=False)
