...
parser.add_argument("--dataset_name", type=str, default="denoised_unet_rgb_augmented", help="name of the dataset")
...
dataloader = DataLoader(
    ImageDataset("../data/%s" % opt.dataset_name, hr_shape=hr_shape, nchannels=opt.channels),
...
for epoch in range(opt.epoch, opt.n_epochs):
    for i, imgs in enumerate(dataloader):
        ...
        if batches_done % opt.sample_interval == 0:
            ...
            img_grid = transforms.Grayscale(num_output_channels=1)(img_grid)
            save_image(img_grid, "images/%d.tif" % batches_done, normalize=False)
